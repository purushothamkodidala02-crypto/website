...
type CatalogStepSelection = { value: string; href: string };

function CatalogSteps({ state, exam, paper }: { state?: CatalogStepSelection; exam?: CatalogStepSelection; paper?: CatalogStepSelection }) {
  const steps = [
  ...
  return (
    <ol className="grid grid-cols-4 overflow-hidden rounded-2xl border bg-white shadow-sm">
