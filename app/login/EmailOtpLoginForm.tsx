...
export function EmailOtpLoginForm({ nextPath, onUsePassword }: { nextPath: string; onUsePassword: () => void }) {
  ...
  async function requestCode(event: React.FormEvent<HTMLFormElement>) {
    ...
    setEmail(normalizedEmail); setSent(true); setNotice({ tone: "success", message: "If this email has a Varadhi Prep account, a six-digit code has been sent." });
  }
